...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		...
		KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, KC_SPC, KC_SPC, MO(2), MO(1), KC_TRNS, CUSTOM_LAUGH, CUSTOM_DANCERS),
	...
	LAYOUT(
		...
		KC_TRNS, KC_LEFT,  KC_DOWN,     KC_RIGHT,  KC_PGDOWN, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
