...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(																														
		...
		KC_LCTL, 	KC_LALT, 	KC_LGUI, 	KC_SPC, 	KC_SPC, 	KC_SPC, 	MO(2), 		MO(1), 		KC_TRNS, 	CUSTOM_LGH, CUSTOM_DAN),

	// DZ60 controls
	LAYOUT(
		KC_GRV, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, KC_DEL,
	...
	LAYOUT(
		...
		KC_TRNS, 	KC_TRNS,  	KC_TRNS,    KC_TRNS,    KC_TRNS,  	KC_TRNS,    KC_TRNS, 	KC_TRNS, 	KC_PGDOWN, 	KC_LEFT, 	KC_DOWN, 	KC_RIGHT, 	KC_TRNS,
		KC_TRNS, 	KC__MUTE, 	KC__VOLDOWN,KC__VOLUP,  KC_TRNS,    KC_TRNS,    KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_RIGHT, 	KC_TRNS,  	KC_TRNS,
		KC_TRNS, 	KC_TRNS,  	KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS),
};